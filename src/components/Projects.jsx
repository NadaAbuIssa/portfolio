...
const jsonplaceholder = `${process.env.PUBLIC_URL}/assets/projects/project6.png`;
      ...
      <div className="flex flex-col justify-center items-center h-full p-16  sm lx md">
        ...
        #################################################################################################################################################################################################################################################################################################*/}
            ...
            <div className="card animate__animated animate__fadeInUp snap-center snap-always flex-shrink-0 w-64">
              ...
              <div className="card-content">
                <h2 className="card-title animate__animated animate__fadeInDown">
                  Dynamic Web Application with JSONPlaceholder API Integration
                </h2>
                <p className="card-description animate__animated animate__fadeIn">
                  integrated with JSONPlaceholder API, offering a seamless user
                  experience while exploring various HTTP methods and data
                  relationships.
                  <a
                    href="https://jsonplaceholder.typicode.com/users"
                    className="color-primary card-description underline"
                  >
                    you can find users data to log in here
                  </a>
                </p>
                ...
                <a
                  className="flex btn-github"
                  href="https://nadaabuissa.github.io/Third-Project/second_task/login.html"
                >
                  <svg
                    width="16"
                    height="16"
