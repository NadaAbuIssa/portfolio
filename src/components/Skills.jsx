        ...
        <div className="flex flex-col m-9 sm md xl" style={{ left: "15%" }}>
          <div className="grid grid-cols-2 | md:grid-cols-3 md:place-content-center | lg:grid-cols-5 mt-5">
            ...
            <div style={{ opacity: 1, transform: "none" }}>
              <div className="transition rounded-xl text-text font-semibold uppercase group text-lg flex flex-col justify-center items-center gap-2 min-w-[10rem] h-[6rem] cursor-default hover:scale-[1.1] hover:shadow-sm hover:bg-accent/10 |">
                <div className="transition w-10 h-10 text-accent group-hover:scale-[1.1] group-hover:animate-bounce">
                  <i
                  ...
                  >
                    ...
                    >
                      <linearGradient
                        id="slr0fspJZ8Sloslbv8ri_a_CMVEhOBzk3Zp_gr1"
                        x1="32.092"
                        x2="32.092"
                        y1="7.766"
                        y2="57.066"
                      ...
                      >
                        <stop offset="0" stopColor="#cc5de8"></stop>
                        <stop offset="1" stopColor="#16528c"></stop>
                      </linearGradient>
                      <path
                        fill="url(#slr0fspJZ8Sloslbv8ri_a_CMVEhOBzk3Zp_gr1)"
                      ...
                      ></path>
                      <linearGradient
                        id="slr0fspJZ8Sloslbv8ri_b_CMVEhOBzk3Zp_gr2"
                        x1="32.001"
                        x2="32.001"
                        y1="7.766"
                        y2="57.066"
                      ...
                      <path
                        fill="url(#slr0fspJZ8Sloslbv8ri_b_CMVEhOBzk3Zp_gr2)"
                      ...
                      <g>
                        <linearGradient
                          id="slr0fspJZ8Sloslbv8ri_c_CMVEhOBzk3Zp_gr3"
                          x1="31.995"
                          x2="31.995"
                          y1="19.575"
                          y2="40.626"
                        ...
                        <path
                          fill="url(#slr0fspJZ8Sloslbv8ri_c_CMVEhOBzk3Zp_gr3)"
                ...
                <h2 className="transition group-hover:scale-[1.1]">html</h2>
              </div>
            </div>
            {/*  */}
            {/* css */}
            <div style={{ opacity: 1, transform: "none" }}>
              <div className="transition rounded-xl text-text font-semibold uppercase group text-lg flex flex-col justify-center items-center gap-2 min-w-[10rem] h-[6rem] cursor-default hover:scale-[1.1] hover:shadow-sm hover:bg-accent/10 |">
                <div className="transition w-10 h-10 text-accent group-hover:scale-[1.1] group-hover:animate-bounce">
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <stop offset="0" stopColor="#cc5de8"></stop>
                        <stop offset=".492" stopColor="#16528c"></stop>
                        <stop offset="1" stopColor="#e6abff"></stop>
                      </linearGradient>
                      <polygon
                ...
                <h2 className="transition group-hover:scale-[1.1]">css</h2>
              </div>
            </div>
            {/*  */}
            {/* javascript */}
            <div style={{ opacity: 1, transform: "none" }}>
              <div className="transition rounded-xl text-text font-semibold uppercase group text-lg flex flex-col justify-center items-center gap-2 min-w-[10rem] h-[6rem] cursor-default hover:scale-[1.1] hover:shadow-sm hover:bg-accent/10 |">
                ...
                <h2 className="transition group-hover:scale-[1.1]">
                  javascript
                </h2>
              </div>
            </div>
            ...
            <div style={{ opacity: 1, transform: "none" }}>
              <div className="transition rounded-xl text-text font-semibold uppercase group text-lg flex flex-col justify-center items-center gap-2 min-w-[10rem] h-[6rem] cursor-default hover:scale-[1.1] hover:shadow-sm hover:bg-accent/10 |">
                ...
                <h2 className="transition group-hover:scale-[1.1]">react</h2>
              </div>
            </div>
            {/*  */}
            ...
            <div style={{ opacity: 1, transform: "none" }}>
              <div className="transition rounded-xl text-text font-semibold uppercase group text-lg flex flex-col justify-center items-center gap-2 min-w-[10rem] h-[6rem] cursor-default hover:scale-[1.1] hover:shadow-sm hover:bg-accent/10 |">
                ...
                <h2 className="transition group-hover:scale-[1.1]">python</h2>
              </div>
            </div>
            {/* Mysql */}
            <div style={{ opacity: 1, transform: "none" }}>
              <div className="transition rounded-xl text-text font-semibold uppercase group text-lg flex flex-col justify-center items-center gap-2 min-w-[10rem] h-[6rem] cursor-default hover:scale-[1.1] hover:shadow-sm hover:bg-accent/10 |">
                ...
                <h2 className="transition group-hover:scale-[1.1]">mysql</h2>
              </div>
            </div>
            {/* postgresql */}
            <div style={{ opacity: 1, transform: "none" }}>
            ...
            <div style={{ opacity: 1, transform: "none" }}>
              <div className="transition rounded-xl text-text font-semibold uppercase group text-lg flex flex-col justify-center items-center gap-2 min-w-[10rem] h-[6rem] cursor-default hover:scale-[1.1] hover:shadow-sm hover:bg-accent/10 |">
                ...
                <h2 className="transition group-hover:scale-[1.1]">github</h2>
              </div>
            </div>
            {/* spring boot */}
            <div style={{ opacity: 1, transform: "none" }}>
            ...
            <div style={{ opacity: 1, transform: "none" }}>
              <div className="transition rounded-xl text-text font-semibold uppercase group text-lg flex flex-col justify-center items-center gap-2 min-w-[10rem] h-[6rem] cursor-default hover:scale-[1.1] hover:shadow-sm hover:bg-accent/10 |">
                ...
                <h2 className="transition group-hover:scale-[1.1]">postman</h2>
              </div>
            </div>
            {/* bash */}
            <div style={{ opacity: 1, transform: "none" }}>
              <div className="transition rounded-xl text-text font-semibold uppercase group text-lg flex flex-col justify-center items-center gap-2 min-w-[10rem] h-[6rem] cursor-default hover:scale-[1.1] hover:shadow-sm hover:bg-accent/10 |">
                ...
                <h2 className="transition group-hover:scale-[1.1]">bash</h2>
              </div>
            </div>
            {/* C */}
            <div style={{ opacity: 1, transform: "none" }}>
              <div className="transition rounded-xl text-text font-semibold uppercase group text-lg flex flex-col justify-center items-center gap-2 min-w-[10rem] h-[6rem] cursor-default hover:scale-[1.1] hover:shadow-sm hover:bg-accent/10 |">
                <div className="transition w-10 h-10 text-accent group-hover:scale-[1.1] group-hover:animate-bounce">
                  ...
                  >
                    <svg
                      ...
                      style={{ enableBackground: "new 0 0 109.19 122.88" }}
                      xmlSpace="preserve"
                    >
                      <style type="text/css">
                        {`.st0{fill-rule:evenodd;clip-rule:evenodd;fill:currentColor;} .st1{fill-rule:evenodd;clip-rule:evenodd;fill:currentColor;} .st2{fill-rule:evenodd;clip-rule:evenodd;fill:currentColor;} .st3{fill-rule:evenodd;clip-rule:evenodd;fill:#FFFFFF;}`}
                      </style>
                      <g>
                        <path
                          className="st0"
                ...
                <h2 className="transition group-hover:scale-[1.1]">C</h2>
              </div>
            </div>
            ...
            <div style={{ opacity: 1, transform: "none" }}>
              <div className="transition rounded-xl text-text font-semibold uppercase group text-lg flex flex-col justify-center items-center gap-2 min-w-[10rem] h-[6rem] cursor-default hover:scale-[1.1] hover:shadow-sm hover:bg-accent/10 |">
                ...
                <h2 className="transition group-hover:scale-[1.1]">java</h2>
              </div>
            </div>
            {/* jupyter notebook */}
            <div style={{ opacity: 1, transform: "none" }}>
